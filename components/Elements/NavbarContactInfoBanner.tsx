			...
			<div className="hidden md:flex flex-row items-center justify-between gap-4 p-2 bg-primary-default">
				<div className="flex flex-row items-center gap-4">
					...
					>
						...
						<Link
							className="font-medium text-tiny font-openSauceSansRegular text-white hover:opacity-70"
					...
					>
						...
						<Link
							className="font-medium text-tiny tracking-tighter font-openSauceSansRegular text-white hover:opacity-70"
