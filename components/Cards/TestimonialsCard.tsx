...
const TestimonialsCard: FC<ITestimonialsCard> = ({
	...
	return (
		<>
			<div className="flex flex-col items-center justify-center p-6 h-full min-h-[250px] rounded-2xl bg-white border-2 border-primary-default border-solid">
				<motion.div
					initial={initial}
					variants={stagger}
					whileInView="animate"
				...
				>
					<Paragraph
						...
						tailwindStyling="max-w-full max-w-sm mx-auto lg:mx-0 text-tiny lg:text-base text-black text-center lg:text-left"
					/>
