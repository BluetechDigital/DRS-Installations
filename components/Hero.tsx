	...
	return (
		<>
			<div className={styles.hero + " hero relative z-50 flex flex-col h-fit"}>
				<div className="lg:relative pt-[65px] md:pt-[112px] lg:pt-[112px]">
					<div
						className="relative w-full h-screen sm:h-[75vh]"
						style={{
					...
					>
						...
						<div className="absolute top-0 w-full h-full">
							<div className="flex flex-col items-center lg:items-baseline justify-center relative h-full">
								<div className="relative z-10 flex flex-col items-center lg:items-start gap-4 p-24">
									<motion.div
										initial={initial}
										variants={stagger}
										whileInView="animate"
